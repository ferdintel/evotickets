...
const FilledButton = ({
  ...
  const commonStyles =
    `flex items-center justify-center gap-x-4 font-semibold ${size === "normal"? "px-4 py-3" : "px-3 py-2 text-sm"} rounded-lg text-nowrap select-none disabled:bg-gray-200 disabled:text-foreground/50 disabled:shadow-[0_0_0_1px_inset_#94a3b8] disabled:cursor-not-allowed duration-300`
