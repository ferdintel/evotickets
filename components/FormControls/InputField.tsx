...
// Utilisation de forwardRef pour gérer le ref
  ...
  <T extends Record<string, unknown>>(
    ...
    return (
      <div className={`w-full flex flex-col gap-y-1 ${addParentWrapperStyles}`}>
        ...
        >
          ...
          <div className="flex items-center">
            ...
            {register && fieldName ? (
              ...
              // input work without state or react-hook-form
              <input
                type={isPassword ? inputType : "text"}
                name={fieldName}
                placeholder={placeholder}
        ...
        {/* error message  */}
        {errorMessage && (
          <p className="cursor-default text-xs mb-1 text-error">
            {errorMessage}
          </p>
        )}
      </div>
...
InputField.displayName = "InputField"; // Important lorsque vous utilisez forwardRef
